...
FOR /f "delims=" %%f IN ('DIR /b /a:-d "%PARENT%temp\kanmusu\*.swf"') DO (
	...
	java -jar "%PARENT%bin\ffdec\ffdec.jar" -replaceAlpha "%%f_images\2x%%f" "%%f_images\debloat_%%f" 35 "%%f_images\2x17.bin" 36 "%%f_images\2x19.bin" 37 "%%f_images\2x27.bin" 38 "%%f_images\2x29.bin"
